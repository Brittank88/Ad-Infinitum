...
public final class AdInfinitumItems implements ItemRegistryContainer {
    ...
    // TODO: @Override public void afterFieldProcessing() { AdInfinitum.LOGGER.info("Registered " + RegistryUtils.getRegisteredAmount(net.minecraft.util.registry.Registry.ITEM, AdInfinitum.MOD_ID) + " items!"); }
