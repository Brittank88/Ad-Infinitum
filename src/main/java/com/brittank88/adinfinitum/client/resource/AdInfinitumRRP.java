...
public abstract class AdInfinitumRRP {
    ...
    public static final String RESOURCE_PACK_ID = AdInfinitum.MOD_ID + ":rrp";
    ...
    public static void registerPack() {
        RESOURCE_PACK.addLang(AdInfinitum.id("en_us"), LANG);
    ...
    public static <T extends ItemGroup> void handleItemGroup(T itemGroup) {
        ...
        LANG.entry("itemGroup." + groupIdentifier, "Ad Infinitum | " + WordUtils.capitalizeFully(StringUtils.removeStart(groupIdentifier, "ad-infinitum.group.")));
