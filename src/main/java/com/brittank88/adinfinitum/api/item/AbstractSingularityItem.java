...
public abstract class AbstractSingularityItem extends Item implements IHaloRenderItem {
    ...
    public static final SpriteIdentifier DEFAULT_BASE_SPRITE_ID      = new SpriteIdentifier(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, AdInfinitum.id("textures/item/singularity/base.png"));
    public static final SpriteIdentifier DEFAULT_CORE_SPRITE_ID      = new SpriteIdentifier(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, AdInfinitum.id("textures/item/singularity/core.png"));
    ...
    public static final OwoItemSettings  DEFAULT_SETTINGS            = new OwoItemSettings().rarity(Rarity.COMMON).group(AdInfinitumGroups.GROUP_SINGULARITIES).tab(0)       ;
